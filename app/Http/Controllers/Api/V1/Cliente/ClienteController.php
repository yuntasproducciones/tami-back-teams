...
class ClienteController extends Controller
{
    ...
    public function getAll()
    {
        try {
            ...
            return $this->apiResponse->errorResponse(
                'Ocurrio un problema al listar los usuarios. ' . $e->getMessage(),
     ...
     * )
     */
    public function create(array $data, StoreClienteRequest $request)
    {
        try {
     ...
     * )
     */
    public function update(array $data, $id, UpdateClienteRequest $request)
    {
        try {
